...
var I18N = {
            en: {
                ...
                installDescAndroid: "Add BMS Local to your home screen for quick one-tap access.",
                btnInstall: "Install",
                ...
                step3Note: "The controller will send its IP to BMS Local, disable Bms_Setup, and redirect you back with IP saved.",
            ...
            zh: {
                ...
                installDescAndroid: "将 BMS Local 添加到主屏幕，享受一键快速访问。",
                btnInstall: "立即安装",
            ...
            ko: {
                ...
                installDescAndroid: "원터치 빠른 실행을 위해 홈 화면에 BMS Local을 추가하세요.",
                btnInstall: "설치하기",
                ...
                step3Note: "컨트롤러가 BMS Local로 IP 주소를 전송하고 Bms_Setup을 끈 후 IP가 저장된 상태로 돌아옵니다.",
            ...
            ru: {
                ...
                step3ResetTitle: "Сменили контроллер или нет связи?",
                step3ResetDesc: "Отвяжите текущий контроллер. Это поможет привязать другой контроллер, либо заново найти этот же при сбоях подключения.",
                ...
                installDescAndroid: "Добавьте BMS Local на главный экран для быстрого доступа.",
